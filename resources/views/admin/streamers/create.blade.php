...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-semibold">New Streamer</h1>
</div>

<form method="POST" action="{{ route('admin.streamers.store') }}" class="bg-white rounded shadow p-6 space-y-4">
    @csrf
    <div>
    ...
    <div>
        ...
        <input name="handle" class="mt-1 block w-full rounded border-gray-300" required>
    </div>
    <div>
    ...
    <div>
        ...
        <textarea name="bio" rows="3" class="mt-1 block w-full rounded border-gray-300" placeholder="Short bio about the streamer..."></textarea>
    </div>

    <button class="bg-indigo-600 text-white px-4 py-2 rounded">Create Streamer</button>
</form>
@endsection
